...
public class ReaperStateMachine : MonoBehaviour
{
...
//  public GameObject DragonSlider;
  ...
  public ReaperEvents eventsScript;
...
//  public AudioSource BossMusic;
  ...
  //  BossMusic.Play();
    ...
    eventsScript = gameObject.GetComponent<ReaperEvents>();
...
//    anim.SetFloat("Speed" , 0);}
  ...
  public void Update ()
  {
    if (seeScript.see == false) //&& (anim.GetBool("CanAttack") == false))
    {
    ...
    {
      this.GetComponent<ReaperStateMachine>().enabled = false;
      this.GetComponent<ReaperStateMachine>().enabled = false;
